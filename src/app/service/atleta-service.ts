...
export class AtletaService {
      ...
      listarAtletas(): Observable<Atleta[]> {
        const urlApi = 'https://6a7f6d923183f5df884b1a61.mockapi.io/esportearlivre/atleta';
        return this.http.get<Atleta[]>(urlApi)
      }
    
      listarAtleta(idAtleta: number): Observable<Atleta> {
        const urlApi = `https://6a7f6d923183f5df884b1a61.mockapi.io/esportearlivre/atleta/${idAtleta}`;
        return this.http.get<Atleta>(urlApi)
      }
      ...
      alterarAtleta(atleta: Atleta): Observable<Atleta> {
        const urlApi = `https://6a7f6d923183f5df884b1a61.mockapi.io/esportearlivre/atleta/${atleta.id}`;
